...
* My modifications include a data set from Microsoft Learn Azure Data Fundamentals (DP-900) and prompt engineering to provide a Q-n-A interface (see screen shots below)
